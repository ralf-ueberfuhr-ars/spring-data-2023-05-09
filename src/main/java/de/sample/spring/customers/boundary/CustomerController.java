...
public class CustomerController {
    ...
    public Collection<Customer> findAllCustomers(@RequestParam(value = "interest", required = false) String interest) {
        if(null != interest) {
            return repo.findAllByInterestsContainingIgnoreCase(interest);
        } else {
            return repo.findAll();
        }
    }
